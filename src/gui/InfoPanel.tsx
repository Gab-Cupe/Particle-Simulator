  ...
  return (
    <div className="info-panel">
      ...
      <div className="info-time">
        ...
        <span className="time-value">{formatValue(currentTime)} s</span>
      </div>
      ...
      <div className="info-particles-list">
        {particulas.map((p) => {
          ...
          const enSuelo = collisibleGround && live.pos[2] <= 0.01;
          let normal = 0;
          if (enSuelo) {
              ...
              <div className="info-particle-body">
                ...
                <div className="info-row">
                  ...
                  <span className="info-value">
                    ({formatValue(live.pos[0])}, {formatValue(live.pos[1])}, {formatValue(live.pos[2])})
                  </span>
                </div>
                ...
                <div className="info-row">
                  ...
                  <span className="info-value">
                    {formatValue(velMag)} m/s
                    <span className="info-subvalue">
                      ({formatValue(live.vel[0])}, {formatValue(live.vel[1])}, {formatValue(live.vel[2])})
                    </span>
                  </span>
                </div>
